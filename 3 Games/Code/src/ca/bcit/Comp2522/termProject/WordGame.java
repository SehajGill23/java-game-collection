...
//
//    // Instance variables for current game
//    private int score;
...
//
//    private int highestScore; // Track the highest score across all games
//
...
//    { // Change: Added getter for numGamesPlayed (Issue 6)
...
//
//        String[] countryNames = world.countries.keySet().toArray(new String[0]);
//
...
//            country = world.countries.get(randomCountryName);
//
//            int questionType = random.nextInt(RANDOM_QUESTION); // 0 = Capital to Country, 1 = Country to Capital, 2 = Fact
//            int result       = askQuestion(questionType);
//
//            if(result == FIRST_ATTEMPT)
//            {
//                firstAttempts++;
//                score += 2; // 2 points for first attempt
//                System.out.println("Correct First Attempts: " + firstAttempts);
//            }
//            else if(result == SECOND_ATTEMPT)
//            {
//                secondAttempts++;
//                score += 1; // 1 point for second attempt
//                System.out.println("Correct Second Attempts: " + secondAttempts);
//            }
//            else
//            {
//                incorrectAttempts++;
...
//        if(playAgain())
//        {
//            playWordGame(); // Start a new game
//        }
//        else
//        {
//            saveAndPrintHighScore(); // Print high score and exit
//        }
//    }
//
...
//                return attempt; // 1 for first attempt, 2 for second attempt
//            }
//            else
//            {
...
//        return 0; // 0 for incorrect after two attempts
//    }
//}
...
//    {
//        System.out.println("\nYour highest score across all games is: " + highestScore);
//    }
//}
